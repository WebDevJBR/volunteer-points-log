...
import { Kingdom, LocalGroup, Volunteer, ToReceivedFundsType_REF, Department } from "../entity";
...
export class ImportController {
  ...
  static async importVolunteers(request: any, response: Response): Promise<void> {
    ...
    const receieveFundsTypeRepo: Repository<ToReceivedFundsType_REF> = getManager().getRepository(ToReceivedFundsType_REF);
